...
#ANTIJS_V2
#cl = LineClient()
cl = LineClient(authToken='EDU2HKImRGOGSCIbgwac.yJ6YzyfEfkPCFkHS/bj3Ba.e8ckLLdNaoR+5jv7PF8k9Tmuj2ZugpoaFGxGVMoXVgk=')
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

#ki = LineClient()
ki = LineClient(authToken='EDvzoKTowHrqVW4k5fj0.qhPFDOQ+35Vkb6OZj8lNSa.WJdVYShniOzRq71Vq8k78/cywMP6Fr+N0RWki1eFGDI=')
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

#kk = LineClient()
kk = LineClient(authToken='ED32dlpBle2FBvcRYeld.1qeeQ7kvNA3LKH90saXX7q.oXIrO+NqYUPyBOKsWgl3F83PgkKpoGCpfek8stj+SSQ=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

#kc = LineClient()
kc = LineClient(authToken='ED32dlpBle2FBvcRYeld.1qeeQ7kvNA3LKH90saXX7q.oXIrO+NqYUPyBOKsWgl3F83PgkKpoGCpfek8stj+SSQ=')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc)
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

#sw = LineClient()
sw = LineClient(authToken='EDvDYIIJEXS1KbtXOvz3.jDTunfbzLJ00bPl/m3ux4W.CICnSuWD0fjMtFlFatX7Ed4OwicfxI2JuZvH3bGHysE=')
...
poll = LinePoll(cl)
call = cl
creator = ["u5eda8a02704d908ee9d06172e85dcc22"]
owner = ["u5eda8a02704d908ee9d06172e85dcc22"]
admin = ["u5eda8a02704d908ee9d06172e85dcc22"]
staff = ["u5eda8a02704d908ee9d06172e85dcc22"]
...
def help():
    ...
    helpMessage = "╔═════════════════\n" +\
                  ...
                  "╠══════════════════════\n" +\
                  "║●●●●" + key + "TiTo ●●●●\n" +\
                  "║" + key + " ●● http://line.me/ti/p/~titoturk ●● \n" +\
                  "╚══════════════════════"
    return helpMessage
